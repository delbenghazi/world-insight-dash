      ...
      {open ? (
        <div className="flex h-full flex-col p-5">
          ...
          <div className="mt-auto space-y-2 border-t pt-5">
            <Link
              to="/add-project"
              className="group flex items-center justify-between rounded-md border border-dashed px-3 py-3 text-sm transition hover:border-primary hover:bg-primary-soft bg-yellow-50"
            >
